...
public class GeneradorClaves {
    ...
    public static void main(String[] args) {
        ...
        byte[] mensajeCifradoBytes = cifradoAsimetrico.cifrarConClavePublica("super");
        System.out.println("bytes! -> " + Arrays.toString(mensajeCifradoBytes));
        System.out.println("Cifrado! -> " + new String(mensajeCifradoBytes));
        System.out.println("Tama�o -> " + mensajeCifradoBytes.length + " bytes");
        System.out.println("-----------");

        String bytesString = new String(mensajeCifradoBytes);
        byte[] bytesStringBytes = bytesString.getBytes();
        //String bytesStringBytesString = new String(bytesStringBytes, charset);

        // Prueba descifrado
        byte[] mensajeDescifradoBytes = cifradoAsimetrico.descifrarConClavePrivada(bytesStringBytes);
